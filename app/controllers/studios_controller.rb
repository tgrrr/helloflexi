class StudiosController < ApplicationController
  before_action :set_studio, only: [:show, :edit, :update, :destroy, :dashboard]
  ...
  # GET /studios/1.json
  def show
    @klasses = Klass.where(studio_id: @studio.id)
  end
  ...
  private
    ...
    def studio_params
      params.require(:studio).permit(:site_ids, :user_id, :logo, :description, :studio_name)
    end
end
